...
import { InventarioItem, InventarioItemFormData } from '../types/inventario';
import AreaSubareaSelector from './AreaSubareaSelector';

interface ItemFormProps {
  onSubmit: (data: InventarioItemFormData) => void;
  onCancel: () => void;
...
const ItemForm: React.FC<ItemFormProps> = ({
  ...
  const [formData, setFormData] = useState<InventarioItemFormData>({
    name: '',
    description: '',
    category: '',
    unit: 'units',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500"
            placeholder="e.g., fragile, perishable, high-value"
          />
        </div>
